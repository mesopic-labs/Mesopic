...
from muster.types import CameraId, FrameTs, NormPoint, Track, TrackId
...
PERSON = "person"
"""The only label that means anything here. Muster counts people (engine §1)."""
...
def _read(payload: bytes) -> dict[str, Any] | None:
    ...
    **Unknown keys are ignored, not refused** — the opposite of the rule `muster.yaml`
