"""`muster spike` — argument handling and, above all, secret hygiene.
...
from muster.types import CameraId, DecodedFrame, Detection, FrameTs, Track, TrackId
...
class _FakeSource:
    ...
    def frames(self) -> Iterator[DecodedFrame]:
        ...
        # real `muster spike` ever takes (ingest/rtsp.py).
