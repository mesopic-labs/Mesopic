...
same quantity counted a second way, and `muster.truth`'s scorer refuses the mix rather
than double it.
...
from muster.analytics.metrics.conversion import ConversionPlugin
from muster.analytics.metrics.footfall import FootfallPlugin
from muster.analytics.metrics.line_cross import LineCrossPlugin
