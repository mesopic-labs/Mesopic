...
reaching for ``mesopic.ingest``, ``av`` or ``cv2``, so "the truth set is numbers" is a
...
from mesopic.truth.clips import (
    ClipManifest,
    Consent,
    ModelRelease,
    Provenance,
...
from mesopic.truth.labels import DRAFT_RATER, Crossing, TruthFile, check_pairing, load_truth
from mesopic.truth.score import (
    Score,
    footfall_per_minute,
    gate_blockers,
