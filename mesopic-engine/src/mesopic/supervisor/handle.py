...
from mesopic.types import CameraId, CameraState, FrameTs, RawEvent

WorkerEntry = Callable[[CameraId, MesopicConfig, WorkerChannels], None]
...
class WorkerHandle:
    ...
    def start(self) -> None:
        ...
        self._process = _SPAWN.Process(
            ...
            name=f"mesopic-worker-{self.camera_id}",
            daemon=True,
        )
        self._process.start()
