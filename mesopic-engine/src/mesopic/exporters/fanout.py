...
def build_exporters(config: MesopicConfig) -> ExporterFanout:
    ...
    if settings.mqtt.enabled:
        ...
        exporters["mqtt"] = MqttExporter(
            ...
            # site id every Mesopic on one broker would announce the same unique_ids, and
