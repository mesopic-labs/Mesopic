...
is recorded in cache metadata and surfaced by `mesopic doctor` and `/healthz`.
...
from mesopic.detector.runtime import DEFAULT_RUNTIME, artefact_tag
...
MODEL_CACHE_ENV_VAR = "MESOPIC_MODEL_CACHE"
DEFAULT_MODEL_CACHE = Path.home() / ".cache" / "mesopic" / "models"
