...
from mesopic.detector.postprocess import decode_yolox_output, letterbox
...
from mesopic.types import DecodedFrame, Detection, Runtime
...
class OnnxDetector:
    ...
    def runtime(self) -> Runtime:
        ...
        What `mesopic doctor` and `/healthz` report, and the first answer to "why is this
