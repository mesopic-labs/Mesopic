...
RUNTIME_ENV_VAR: Final = "MESOPIC_DETECTOR_RUNTIME"
"""Operator-facing override. P2.1 will route `mesopic.yaml` to the same resolution."""
...
def available_runtimes() -> tuple[Runtime, ...]:
    ...
    What `mesopic doctor` renders, and the answer to "why is this box slower than that
