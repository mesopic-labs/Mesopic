...
from mesopic.aggregator.aggregator import EXIT_GRACE_S
...
from mesopic.supervisor.handle import STALL_AFTER_S, WorkerEntry, WorkerReport
from mesopic.supervisor.supervisor import BUCKET_S, CLOSE_LAG_S, Supervisor
...
def _supervisor(
    config: MesopicConfig, store: Store, clock: FakeClock, entry: WorkerEntry
) -> Supervisor:
