...
from mesopic.supervisor.control import SnapshotReply
from mesopic.supervisor.snapshot import encode_snapshot
from mesopic.tracker.bytetrack import ByteTrackTracker
from mesopic.types import CameraId, DecodedFrame, Detection, FrameTs
...
def test_frame_pixels_do_not_reach_the_filesystem_when_the_consumer_stops_early(
    ...
    """`mesopic spike | head -1` unwinds the loop through `GeneratorExit`.
