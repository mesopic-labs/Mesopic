...
from mesopic.api.board import Cohort, tiles_for
...
def _config(*, staff_zone: bool = True) -> MesopicConfig:
...
def _mixed_config() -> MesopicConfig:
    ...
    return MesopicConfig.model_validate(base)
