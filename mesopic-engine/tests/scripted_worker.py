...
from mesopic.supervisor.control import ControlMessage, Heartbeat, Retarget, Stop, WorkerChannels
from mesopic.types import CameraId, EventKind, FrameTs, LineId, RawEvent, TrackId, ZoneId
...
def emit_then_exit(
    camera_id: CameraId,
    config: MesopicConfig,  # the entry-point contract
